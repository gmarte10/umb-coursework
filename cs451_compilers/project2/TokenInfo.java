...
enum TokenKind {
    ...
    MINUS("-"), PLUS("+"), PLUS_ASSIGN("+="), STAR("*"), DIV("/"), REM("%"), LSHIFT("<<"),
    RSHIFT(">>"), LRSHIFT(">>>"), COMP("~"), AND("&"), XOR("^"), OR("|"),
    // New operators
    QUEST("?"), NOTEQ("!="), DIVEQ("/="), MINUSEQ("-="), STAREQ("*="), REMEQ("%="),
    RSHIFTEQ(">>="), LRSHIFTEQ(">>>="), GTEQ(">="), LSHIFTEQ("<<="), LT("<"),
    XOREQ("^="), OREQ("|="), LOR("||"), ANDEQ("&="),
