    ...
    public TokenInfo getNextToken() {
        ...
        switch (ch) {
            ...
            case '.':
                ...
                nextCh();
                // Check if double
                while (isDigit(ch) || ch == 'd' || ch == 'D' || ch == 'e' || ch == 'E' || ch == '-' || ch == '+') {
                    if (ch == 'D' || ch == 'd' && buffer.length() >= 2) {
                        if (buffer.indexOf("d") == -1 && buffer.indexOf("D") == -1) {
                            buffer.append(ch);
                        }
                        nextCh();
                        break;
                    }
                    else if (ch == 'E' || ch == 'e' && buffer.length() >= 2) {
                        if (buffer.indexOf("e") == -1 && buffer.indexOf("E") == -1) {
                            buffer.append(ch);
                        }
                        nextCh();
                    }
                    else if (ch == '+' || ch == '-' && buffer.length() >= 2 && (buffer.indexOf("e") == buffer.length() - 1
                    || buffer.indexOf("E") == buffer.length() - 1) && (buffer.indexOf("+") == -1 && buffer.indexOf("-") == -1)) {
                        buffer.append(ch);
                        nextCh();
                    }
                    else {
            ...
            case '*':
                ...
                if (ch == '=') {
                    nextCh();
                    return new TokenInfo(STAREQ, line);
                }
                else {
            ...
            case '%':
                ...
                if (ch == '=') {
                    nextCh();
                    return new TokenInfo(REMEQ, line);
                }
            ...
            case '-':
                ...
                if (ch == '=') {
                    nextCh();
                    return new TokenInfo(MINUSEQ, line);
                }
                if (ch == '-') {
                    nextCh();
            ...
            case '~':
                nextCh();
                return new TokenInfo(COMP, line);
            case '>':
                nextCh();
                if (ch == '>') {
                    nextCh();
                    if (ch == '>') {
                        ...
                        if (ch == '=') {
                            nextCh();
                            return new TokenInfo(LRSHIFTEQ, line);
                        }
                        else {
                        ...
                        nextCh();
                        return new TokenInfo(RSHIFTEQ, line);
                    }
                    else {
            ...
            case '<':
                ...
                if (ch == '=') {
                    ...
                    if (ch == '=') {
                        nextCh();
                        return new TokenInfo(LSHIFTEQ, line);
                    }
                    else {
            ...
            case '^':
                ...
                if (ch == '=') {
                    nextCh();
                    return new TokenInfo(XOREQ, line);
                }
                else {
            ...
            case '|':
                ...
                if (ch == '=') {
                    nextCh();
                    return new TokenInfo(OREQ, line);
                }
                else if (ch == '|') {
                    nextCh();
            ...
            case '9':
                buffer = new StringBuffer();
                // Accept integer, double and long
                while (isDigit(ch) || ch == '.' || ch == 'e' || ch == 'E' || ch == 'd' || ch == 'D' ||
                ch == '-' || ch == '+' | ch == 'l' || ch == 'L') {
                    buffer.append(ch);
                    nextCh();
                }
                // Check if double
                if (buffer.indexOf(".") != -1 || buffer.indexOf("e") != -1 || buffer.indexOf("E") != -1 || buffer.indexOf("d") != -1 ||
                        buffer.indexOf("D") != -1 || buffer.indexOf("+") != -1 || buffer.indexOf("-") != -1) {
                    return new TokenInfo(DOUBLE_LITERAL, buffer.toString(), line);
                }
                // Check if long
                else if (buffer.indexOf("l") != -1 || buffer.indexOf("L") != -1) {
